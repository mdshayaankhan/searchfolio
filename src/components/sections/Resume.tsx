      ...
      <CardContent className="space-y-8">
        ...
        <div>
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <p className="mt-1"><strong>Description:</strong> Developed a predictive model using linear regression to analyse factors contributing to employee burnout. Conducted exploratory data analysis, data cleaning, and feature engineering.</p>
                    <p className="text-sm"><strong>Technologies Used:</strong> Python, Google Colab, Pandas, Scikit-learn, GridSearchCV.</p>
                    <p className="text-sm"><strong>Key Achievements:</strong> Achieved an R² score of 0.85 after hyperparameter tuning; reduced model error by 20%.</p>
                    <a href="https://github.com/mdshayaankhan/Employee-Burnout-Analysis" target="_blank" rel="noreferrer" className="text-primary hover:underline text-sm">Repository</a>
                </div>
                 <div>
                    ...
                    <p className="mt-1"><strong>Description:</strong> Created interactive dashboards to analyse 19 years of agricultural data across crops, seasons, and regions. Provided actionable insights for policymakers.</p>
                    <p className="text-sm"><strong>Technologies Used:</strong> Power BI, Excel.</p>
                    <p className="text-sm"><strong>Key Achievements:</strong> Identified underperforming crops and regions; presented findings to stakeholders to inform policy decisions.</p>
                    <a href="https://github.com/mdshayaankhan/Agricultural-Analysis" target="_blank" rel="noreferrer" className="text-primary hover:underline text-sm">Repository</a>
                </div>
                 <div>
                    ...
                    <p className="mt-1"><strong>Description:</strong> Developed a MERN stack web app to connect rescue pets with adopters, featuring a secure user interface and real-time updates.</p>
                    <p className="text-sm"><strong>Technologies:</strong> MongoDB, Express.js, React, Node.js.</p>
                    <p className="text-sm"><strong>Key Achievements:</strong> Implemented a user-friendly interface, resulting in a 40% increase in adoption inquiries within three months, establishing a best practice model for future digital initiatives.</p>
                    <a href="https://github.com/mdshayaankhan/PetAdoption" target="_blank" rel="noreferrer" className="text-primary hover:underline text-sm">Repository</a>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Academic: Achieved consistent excellence in academics.</li>
              <li>Co-curricular: Acknowledged for achievements in sports, particularly cricket.</li>
              <li>Extracurricular: Actively participated in hackathons, coding challenges, and English language competitions.</li>
